...
class Trial(object):
    def __init__(self):
        ...
        self.stimuli_idx = [0, 1, 2, 3, 4, 5, 6, 7, 8]
        ...
        self.delay_interval = [5, 10, 15, 20]                                       # Create a list of the four delay intervals
...
#----------------------------------------------------------------
    ...
    def blank_screen(self):
        ...
        cursor.draw(screen)
        moveCursor(cursor)
        #if self.time_delay() >= self.delay_interval[random.randint(0,3)]:
